#ifndef _FE_CORE_SMART_PTR_VARIANTS_BASE_HPP_
#define _FE_CORE_SMART_PTR_VARIANTS_BASE_HPP_
...
template<typename T>
class owner_ptr_base : public smart_ptr_variants_base
{
public:
...
protected:
	...
	_CONSTEXPR20_ owner_ptr_base() noexcept : m_smart_ptr(), m_key(base_type::invalid_key_value) {}
	_CONSTEXPR20_ owner_ptr_base(pointer value_p) noexcept : m_smart_ptr(value_p), m_key(base_type::invalid_key_value) {}
	_CONSTEXPR20_ ~owner_ptr_base() noexcept = default;
...
class safe_ptr_base : public smart_ptr_variants_base
{
public:
	using base_type = smart_ptr_variants_base;
