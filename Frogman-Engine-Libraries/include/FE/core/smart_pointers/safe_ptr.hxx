#ifndef _FE_CORE_SAFE_PTR_HXX_
#define _FE_CORE_SAFE_PTR_HXX_
...
template<typename T>
class safe_ptr final : public internal::smart_ptr::safe_ptr_base
{
public:
	using base_type = internal::smart_ptr::safe_ptr_base;
...
public:
	_CONSTEXPR20_ safe_ptr() noexcept : m_smart_ptr(), m_key(base_type::invalid_key_value) {}

	_CONSTEXPR20_ safe_ptr(const safe_ptr& other_p) noexcept : m_smart_ptr(reinterpret_cast<pointer>(base_type::__get_property_address(other_p.m_key))), m_key(base_type::invalid_key_value)
	{
	...
	_CONSTEXPR20_ safe_ptr(safe_ptr&& rvalue_p) noexcept : m_smart_ptr(reinterpret_cast<pointer>(base_type::__get_property_address(rvalue_p.m_key))), m_key(base_type::invalid_key_value)
	{
		if (this->m_smart_ptr != nullptr)
		{
	...
	_CONSTEXPR20_ safe_ptr(const FE::owner_ptr<T, Allocator>& exclusive_ptr_p) noexcept : m_smart_ptr(reinterpret_cast<pointer>(base_type::__get_property_address(exclusive_ptr_p.get_key()))), m_key(base_type::invalid_key_value)
	{
		if (this->m_smart_ptr != nullptr)
		{
	...
	_CONSTEXPR20_ safe_ptr& operator=(const safe_ptr& other_p) noexcept
	{
	...
	_CONSTEXPR20_ safe_ptr& operator=(safe_ptr&& rvalue_p) noexcept
	{
	...
	template<class Allocator>
	_CONSTEXPR20_ safe_ptr& operator=(const FE::owner_ptr<T, Allocator>& exclusive_ptr_p) noexcept
	{
		if (!exclusive_ptr_p)
		{
			return *this;
	...
	_FORCE_INLINE_ ref_table_key_type get_key() const noexcept
	{
 	...
 	_CONSTEXPR20_ void swap(safe_ptr& in_out_other_p) noexcept
	{
	...
	_FORCE_INLINE_ boolean operator==(const safe_ptr& other_p) const noexcept
	{
		this->m_smart_ptr = reinterpret_cast<pointer>(base_type::__get_property_address(this->m_key));
	...
	template<class Allocator>
	_FORCE_INLINE_ boolean operator==(const FE::owner_ptr<T, Allocator>& other_p) const noexcept
	{
		this->m_smart_ptr = reinterpret_cast<pointer>(base_type::__get_property_address(this->m_key));
...
template<typename T>
class safe_ptr<T[]> final : public internal::smart_ptr::safe_ptr_base
{
	using base_type = internal::smart_ptr::safe_ptr_base;
	using ref_table_key_type = typename base_type::ref_table_key_type;
...
public:
	_CONSTEXPR20_ safe_ptr() noexcept : m_smart_ptr(), m_smart_ptr_end(), m_key(base_type::invalid_key_value) {}

	_CONSTEXPR20_ safe_ptr(const safe_ptr& other_p) noexcept : m_smart_ptr(reinterpret_cast<pointer>(base_type::__get_property_address(other_p.m_key))), m_smart_ptr_end(other_p.m_smart_ptr_end), m_key(base_type::invalid_key_value)
	{
		if (this->m_smart_ptr != nullptr)
		{
			this->m_key = other_p.m_key;
	...
	_CONSTEXPR20_ safe_ptr(safe_ptr&& rvalue_p) noexcept : m_smart_ptr(reinterpret_cast<pointer>(base_type::__get_property_address(rvalue_p.m_key))), m_smart_ptr_end(rvalue_p.m_smart_ptr_end), m_key(base_type::invalid_key_value)
	{
		if (this->m_smart_ptr != nullptr)
		{
			rvalue_p.m_smart_ptr = nullptr;
	...
	template<class Allocator>
	_CONSTEXPR20_ safe_ptr(const FE::owner_ptr<T[], Allocator>& exclusive_ptr_p) noexcept : m_smart_ptr(reinterpret_cast<pointer>(base_type::__get_property_address(exclusive_ptr_p.get_key()))), m_smart_ptr_end(), m_key(base_type::invalid_key_value)
	{
		if (this->m_smart_ptr != nullptr)
		{
			this->m_key = exclusive_ptr_p.get_key();
