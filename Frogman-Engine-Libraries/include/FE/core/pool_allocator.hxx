...
public:
	...
	_MAYBE_UNUSED_ static constexpr inline ADDRESS is_address_aligned = (std::is_same<alignment_type, FE::SIMD_auto_alignment::alignment_type>::value == true) ? ADDRESS::_ALIGNED : ADDRESS::_NOT_ALIGNED;
